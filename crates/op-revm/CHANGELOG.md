...
## [14.2.0](https://github.com/imotai/revm/compare/op-revm-v14.1.0...op-revm-v14.2.0) - 2026-01-09
...
- early return if the l1 fee scalar is zero ([#3213](https://github.com/imotai/revm/pull/3213))
...
- Remove redundant tx fetch in Optimism handler gas accounting ([#3220](https://github.com/imotai/revm/pull/3220))
