...
## [32.0.1](https://github.com/imotai/revm/compare/revm-precompile-v32.0.0...revm-precompile-v32.0.1) - 2026-02-27

### Fixed

- *(precompile)* use big-endian resize for modexp output padding ([#3432](https://github.com/imotai/revm/pull/3432))

### Other

- remove GPL mention and update gmp feature comments ([#3383](https://github.com/imotai/revm/pull/3383))
- *(precompile)* zero-copy scalar conversion in BLS12-381 MSM ([#3359](https://github.com/imotai/revm/pull/3359))
- use fixed bytes hashmaps from alloy-core ([#3358](https://github.com/imotai/revm/pull/3358))
- *(precompiles)* cache trusted setup G2 for kzg ([#3322](https://github.com/imotai/revm/pull/3322))
- rename misleading calc_linear_cost_u32 function ([#3318](https://github.com/imotai/revm/pull/3318))
