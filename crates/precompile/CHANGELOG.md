...
## [31.1.0](https://github.com/imotai/revm/compare/revm-precompile-v31.0.0...revm-precompile-v31.1.0) - 2026-01-09

### Added

- rm gmp use-system-libs ([#3253](https://github.com/imotai/revm/pull/3253))
- dynamically link gmp ([#3250](https://github.com/imotai/revm/pull/3250))
...
- optimize precompile `extend()` ([#3192](https://github.com/imotai/revm/pull/3192))
