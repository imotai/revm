...
## [29.0.0](https://github.com/imotai/revm/compare/revm-precompile-v28.1.1...revm-precompile-v29.0.0) - 2025-10-23

### Added

- [**breaking**] Remove kzg-rs ([#2909](https://github.com/imotai/revm/pull/2909))
- *(fusaka)* Add PrecompileId ([#2904](https://github.com/imotai/revm/pull/2904))
- short address for journal cold/warm check ([#2849](https://github.com/imotai/revm/pull/2849))
- optimize access to precompile short addresses ([#2846](https://github.com/imotai/revm/pull/2846))
- Reuse bls12-381 codepaths to implement kzg point evaluation precompile ([#2809](https://github.com/imotai/revm/pull/2809))
- rename bn128 to bn254 for Ethereum standard consistency ([#2810](https://github.com/imotai/revm/pull/2810))
- *(precompiles)* Use bytes API for underlying precompile library APIs ([#2705](https://github.com/imotai/revm/pull/2705))
- *(precompile)* update osaka modexp gas divisor ([#2740](https://github.com/imotai/revm/pull/2740))
- *(precompile)* update p256 verify osaka gas cost ([#2741](https://github.com/imotai/revm/pull/2741))
- add a way for precompiles to revert ([#2711](https://github.com/imotai/revm/pull/2711))
- blake2 avx2 ([#2670](https://github.com/imotai/revm/pull/2670))
- *(osaka)* modexp assume minimal base/mod length of 32 ([#2613](https://github.com/imotai/revm/pull/2613)) ([#2643](https://github.com/imotai/revm/pull/2643))
- *(precompile)* rug/gmp-based modexp ([#2596](https://github.com/imotai/revm/pull/2596))
- add basic tests for modexp ([#2603](https://github.com/imotai/revm/pull/2603))
...
- *(Osaka)* modexp input limit and gas change, EIP-7823 and EIP-7883 ([#2531](https://github.com/imotai/revm/pull/2531))
- skip cloning of call input from shared memory ([#2462](https://github.com/imotai/revm/pull/2462))
- Add arkworks wrapper for bls12-381 ([#2316](https://github.com/imotai/revm/pull/2316))
- Add a wrapper for arkworks for EIP196 ([#2305](https://github.com/imotai/revm/pull/2305))
- add bn_mul benchmark ([#2287](https://github.com/imotai/revm/pull/2287))
- Return Fatal error on bls precompiles if in no_std ([#2249](https://github.com/imotai/revm/pull/2249))
- bls special case G1/G2_MUL ([#2248](https://github.com/imotai/revm/pull/2248))
...
- use batch bn256 pair operation ([#1643](https://github.com/imotai/revm/pull/1643))
- use `kzg-rs` for kzg point evaluation ([#1558](https://github.com/imotai/revm/pull/1558))
- *(Precompiles)* Throw fatal error if c-kzg is disabled ([#1589](https://github.com/imotai/revm/pull/1589))
- *(precompiles)* fatal error for precompiles ([#1499](https://github.com/imotai/revm/pull/1499))
- add ecAdd to precompile bench ([#1496](https://github.com/imotai/revm/pull/1496))
...
- *(precompile)* add Prague hardfork specification ([#1387](https://github.com/imotai/revm/pull/1387))
...
- make all precompiles public ([#1213](https://github.com/imotai/revm/pull/1213))
- add benchmarks for ecpairing, kzg, ecrecover precompiles ([#1211](https://github.com/imotai/revm/pull/1211))
- use Message::from_digest in secp256k1 ecrecover ([#1199](https://github.com/imotai/revm/pull/1199))
- *(precompile)* add a bool to bytes32 helper function ([#1170](https://github.com/imotai/revm/pull/1170))
...
- *(precompile)* use Aurora modexp lib. ([#769](https://github.com/imotai/revm/pull/769))
...
- *(kzg/blst)* use uncompress for compressed G1/G2 inputs ([#3067](https://github.com/imotai/revm/pull/3067))
- racecondition return on install_crypto fn ([#2997](https://github.com/imotai/revm/pull/2997))
- Apply spelling corrections from PRs #2926, #2915, #2908 ([#2978](https://github.com/imotai/revm/pull/2978))
- *(osaka)* do base/mod zero check after gas calc ([#2872](https://github.com/imotai/revm/pull/2872))
- map new once and for all (+ci) ([#2852](https://github.com/imotai/revm/pull/2852))
- features and check in ci ([#2766](https://github.com/imotai/revm/pull/2766))
- *(isthmus)* Add input size limitations to bls12-381 {G1/G2} MSM + pairing ([#2406](https://github.com/imotai/revm/pull/2406))
...
- *(blst)* Fix blst wrong constants values and usage ([#2102](https://github.com/imotai/revm/pull/2102))
...
- check canonical Fp elements ([#1434](https://github.com/imotai/revm/pull/1434))
- *(precompile)* ignore infinity points in G1 MSM ([#1432](https://github.com/imotai/revm/pull/1432))
- *(precompile)* BLS G2 MSM ([#1428](https://github.com/imotai/revm/pull/1428))
- *(precompile)* blst dangling pointers, cleanup ([#1391](https://github.com/imotai/revm/pull/1391))
- *(precompile)* inherit Prague precompiles from Cancun ([#1392](https://github.com/imotai/revm/pull/1392))
- update/enable bn128 tests ([#1242](https://github.com/imotai/revm/pull/1242))
- use correct bn128 mul input length ([#1238](https://github.com/imotai/revm/pull/1238))
- use correct rand package for thread_rng ([#1233](https://github.com/imotai/revm/pull/1233))
...
- pairing cost formula  ([#659](https://github.com/imotai/revm/pull/659))
...
- *(precompile)* remove unused mainnet_address() function ([#3091](https://github.com/imotai/revm/pull/3091))
...
- typo imputs ([#3031](https://github.com/imotai/revm/pull/3031))
- add display for precompileid ([#3018](https://github.com/imotai/revm/pull/3018))
- Remove libsecp256k1 parity lib ([#2954](https://github.com/imotai/revm/pull/2954))
- add SECURITY.md ([#2956](https://github.com/imotai/revm/pull/2956))
- add amsterdam in spec id ([#2934](https://github.com/imotai/revm/pull/2934))
- cargo update ([#2930](https://github.com/imotai/revm/pull/2930))
- *(precompile)* add new specific `PrecompileError` variants ([#2907](https://github.com/imotai/revm/pull/2907))
- add Precompil::into_precompile ([#2913](https://github.com/imotai/revm/pull/2913))
...
- simplify the ecrecover test ([#2836](https://github.com/imotai/revm/pull/2836))
...
- add OnceLock re-export with no_std support ([#2787](https://github.com/imotai/revm/pull/2787))
- fix clippy ([#2785](https://github.com/imotai/revm/pull/2785))
- Add dyn Crypto trait to PrecompileFn ([#2772](https://github.com/imotai/revm/pull/2772))
- release ([#2771](https://github.com/imotai/revm/pull/2771))
- use `EncodedPoint` to decode uncompressed public key ([#2736](https://github.com/imotai/revm/pull/2736))
- *(precompile)* refactor blake2 input parsing ([#2734](https://github.com/imotai/revm/pull/2734))
- Add blake2 benchmarks ([#2735](https://github.com/imotai/revm/pull/2735))
...
- use c-kzg precompute value 8 ([#2698](https://github.com/imotai/revm/pull/2698))
...
- bump all deps ([#2647](https://github.com/imotai/revm/pull/2647))
- build less benchmark binaries ([#2629](https://github.com/imotai/revm/pull/2629))
...
- fixed dead link kzg_point_evaluation.rs ([#2508](https://github.com/imotai/revm/pull/2508))
...
- make OPCODE_INFO a static ([#2459](https://github.com/imotai/revm/pull/2459))
...
- *(docs)* precompile crate ([#2413](https://github.com/imotai/revm/pull/2413))
- bump stable tests, introduce lints ([#2403](https://github.com/imotai/revm/pull/2403))
- bump v68 revm v22.0.0 ([#2396](https://github.com/imotai/revm/pull/2396))
- fixed `EIP` to `RIP` ([#2388](https://github.com/imotai/revm/pull/2388))
- *(precompile)* remove unused dependencies ([#2378](https://github.com/imotai/revm/pull/2378))
- add 0x prefix to b256! and address! calls ([#2345](https://github.com/imotai/revm/pull/2345))
- alloy 0.13 and kzg v2.1.0 ([#2342](https://github.com/imotai/revm/pull/2342))
- release-plz ([#2340](https://github.com/imotai/revm/pull/2340))
- [**breaking**] Move modulus constant into blst wrapper ([#2336](https://github.com/imotai/revm/pull/2336))
- Remove TODO for NBITS and remove NBITS from blst MSM API ([#2337](https://github.com/imotai/revm/pull/2337))
- remove no-std method for bls ([#2338](https://github.com/imotai/revm/pull/2338))
- Move all benchmarks into their own module like eip2537 ([#2335](https://github.com/imotai/revm/pull/2335))
- add bls12-381 benchmarks ([#2327](https://github.com/imotai/revm/pull/2327))
- add encode_fp function ([#2328](https://github.com/imotai/revm/pull/2328))
- clean up blst wrapper doc comment and types ([#2314](https://github.com/imotai/revm/pull/2314))
- Move all blst related methods into blst wrapper ([#2313](https://github.com/imotai/revm/pull/2313))
- Remove LATEST variant from SpecId enum ([#2299](https://github.com/imotai/revm/pull/2299))
...
- *(op-precompiles)* Add missing g2 add tests ([#2253](https://github.com/imotai/revm/pull/2253))
- v65 revm: v20.0.0-alpha.7 ([#2280](https://github.com/imotai/revm/pull/2280))
- add early exit for no-ops in EIP1962 and EIP2537 ([#2271](https://github.com/imotai/revm/pull/2271))
- *(op-precompiles)* Check subset of l1 precompiles in op ([#2204](https://github.com/imotai/revm/pull/2204))
- Add `g1_mul`, `g1_add` and `read_scalar` methods into substrate wrapper for bn128 ([#2264](https://github.com/imotai/revm/pull/2264))
- *(op-precompiles)* clean up op tx tests ([#2242](https://github.com/imotai/revm/pull/2242))
- Adds a wrapper around substrate-bn for EIP196 ([#2258](https://github.com/imotai/revm/pull/2258))
- add invariant test for G1/G2 Mul ([#2247](https://github.com/imotai/revm/pull/2247))
- add documentation for the gas related constants for EIP2537 ([#2246](https://github.com/imotai/revm/pull/2246))
- add a safe blst wrapper ([#2223](https://github.com/imotai/revm/pull/2223))
- Remove redundant bls12-381 constants and cleanup naming ([#2235](https://github.com/imotai/revm/pull/2235))
- Add some documentation for the bls12-381 precompile constants ([#2222](https://github.com/imotai/revm/pull/2222))
...
- *(precompile)* refactor out msm helper ([#2179](https://github.com/imotai/revm/pull/2179))
...
- simplify bn128::run_pair ([#2137](https://github.com/imotai/revm/pull/2137))
...
- Update broken link secp256r1.rs ([#2099](https://github.com/imotai/revm/pull/2099))
- G1_msm base gas fee const correction ([#2100](https://github.com/imotai/revm/pull/2100))
...
- bump kzg.rs ([#2002](https://github.com/imotai/revm/pull/2002))
- align crates versions ([#1983](https://github.com/imotai/revm/pull/1983))
- blst reprice, remove g1/g2 mul ([#1981](https://github.com/imotai/revm/pull/1981))
- integrate rust-secp256k1 ([#1915](https://github.com/imotai/revm/pull/1915))
...
- *(precompile)* use secp256k1 global context for ecrecover ([#1843](https://github.com/imotai/revm/pull/1843))
- fix some typos ([#1800](https://github.com/imotai/revm/pull/1800))
- Replace `PrecompileError` variant ([#1797](https://github.com/imotai/revm/pull/1797))
- *(deps)* bump once_cell from 1.19.0 to 1.20.0 ([#1773](https://github.com/imotai/revm/pull/1773))
...
- bump kzg-rs version ([#1734](https://github.com/imotai/revm/pull/1734))
- main changelog ([#1730](https://github.com/imotai/revm/pull/1730))
- release ([#1722](https://github.com/imotai/revm/pull/1722))
- bump `kzg-rs` version ([#1726](https://github.com/imotai/revm/pull/1726))
- switch gas check order in blake2 precompile ([#1718](https://github.com/imotai/revm/pull/1718))
...
- *(deps)* bump blst from 0.3.12 to 0.3.13 ([#1669](https://github.com/imotai/revm/pull/1669))
...
- main CHANGELOG ([#1592](https://github.com/imotai/revm/pull/1592))
...
- *(precompiles)* Fix some nits in bls12_381 ([#1495](https://github.com/imotai/revm/pull/1495))
- *(deps)* allow multiple versions of secp256k1 ([#1490](https://github.com/imotai/revm/pull/1490))
- *(deps)* bump rstest from 0.19.0 to 0.21.0 ([#1482](https://github.com/imotai/revm/pull/1482))
- *(deps)* bump blst from 0.3.11 to 0.3.12 ([#1481](https://github.com/imotai/revm/pull/1481))
- add test for map_fp_to_g1 precompile ([#1465](https://github.com/imotai/revm/pull/1465))
- add docs for BLS scalar input decoding ([#1446](https://github.com/imotai/revm/pull/1446))
- release ([#1261](https://github.com/imotai/revm/pull/1261))
- add Trin to used by list ([#1393](https://github.com/imotai/revm/pull/1393))
- bump c-kzg to 1.0.2 ([#1390](https://github.com/imotai/revm/pull/1390))
- refactor lints ([#1386](https://github.com/imotai/revm/pull/1386))
- *(deps)* bump aurora-engine-modexp from 1.0.0 to 1.1.0 ([#1339](https://github.com/imotai/revm/pull/1339))
- *(deps)* bump secp256k1 from 0.28.2 to 0.29.0 ([#1260](https://github.com/imotai/revm/pull/1260))
- release ([#1231](https://github.com/imotai/revm/pull/1231))
- remove unnecessary call to into_u256() for bn128 add ([#1239](https://github.com/imotai/revm/pull/1239))
...
- expose functionality for custom EVMs ([#1201](https://github.com/imotai/revm/pull/1201))
- c-kzg v1.0.0 ([#1190](https://github.com/imotai/revm/pull/1190))
...
- *(precompile)* don't allocate if padding is not needed ([#1075](https://github.com/imotai/revm/pull/1075))
- *(precompile)* simplify bn128 precompile implementations ([#1074](https://github.com/imotai/revm/pull/1074))
- *(precompile)* make use of padding utilities, simplify secp256k1 ([#1073](https://github.com/imotai/revm/pull/1073))
- precompile bn128 copy ([#1071](https://github.com/imotai/revm/pull/1071))
...
- *(deps)* bump secp256k1 from 0.28.1 to 0.28.2 ([#1038](https://github.com/imotai/revm/pull/1038))
- *(Cancun)* update Cancun precompiles docs ([#1015](https://github.com/imotai/revm/pull/1015))
- *(log)* use alloy_primitives::Log ([#975](https://github.com/imotai/revm/pull/975))
- *(deps)* bump k256 from 0.13.2 to 0.13.3 ([#959](https://github.com/imotai/revm/pull/959))
- *(deps)* bump secp256k1 from 0.28.0 to 0.28.1 ([#954](https://github.com/imotai/revm/pull/954))
- *(deps)* bump once_cell from 1.18.0 to 1.19.0 ([#908](https://github.com/imotai/revm/pull/908))
...
- *(precompiles)* Make PrecompileWithAddress field public, from impl ([#857](https://github.com/imotai/revm/pull/857))
- change addresses to iterator and add into_addresses ([#855](https://github.com/imotai/revm/pull/855))
- bump c-kzg to v0.4.0 ([#849](https://github.com/imotai/revm/pull/849))
- Refactor precompile list from Hash to vec ([#823](https://github.com/imotai/revm/pull/823))
- *(eip4844)* update kzg trusted setup ([#822](https://github.com/imotai/revm/pull/822))
- secp256k1 from 0.27 to 0.28 ([#817](https://github.com/imotai/revm/pull/817))
...
- bump c-kzg to create lib ([#758](https://github.com/imotai/revm/pull/758))
- Readme Updates ([#756](https://github.com/imotai/revm/pull/756))
- *(deps)* bump sha2 from 0.10.7 to 0.10.8 ([#752](https://github.com/imotai/revm/pull/752))
- modexp gas check ([#737](https://github.com/imotai/revm/pull/737))
...
- *(deps)* bump sha3 from 0.10.6 to 0.10.7 ([#454](https://github.com/imotai/revm/pull/454))
- v21, revm v3.1.0 ([#444](https://github.com/imotai/revm/pull/444))
- bump all
- *(deps)* bump secp256k1 from 0.26.0 to 0.27.0 ([#429](https://github.com/imotai/revm/pull/429))
- Update README.md ([#424](https://github.com/imotai/revm/pull/424))
- add primitive SpecId to precompile SpecId conversion ([#408](https://github.com/imotai/revm/pull/408))
