...
## [23.0.3](https://github.com/imotai/revm/compare/revm-interpreter-v23.0.2...revm-interpreter-v23.0.3) - 2025-07-18

### Other

- add release safety section for SharedMemory fn ([#2718](https://github.com/imotai/revm/pull/2718))
- *(interpreter)* update docs for slice_mut and slice_range ([#2714](https://github.com/imotai/revm/pull/2714))
