...
## [32.0.0](https://github.com/imotai/revm/compare/revm-interpreter-v31.1.0...revm-interpreter-v32.0.0) - 2026-01-09
...
- add optimization for push and pop ([#3263](https://github.com/imotai/revm/pull/3263))
- happy new year, 2026 licence ([#3272](https://github.com/imotai/revm/pull/3272))
- avoid loading bytecode in extcodehash ([#3261](https://github.com/imotai/revm/pull/3261))
