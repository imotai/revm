...
## [26.0.0](https://github.com/imotai/revm/compare/revm-interpreter-v25.0.2...revm-interpreter-v26.0.0) - 2025-09-19
...
- rm eof comments ([#2987](https://github.com/imotai/revm/pull/2987))
- comments on EIP-2929/2930 constants ([#2969](https://github.com/imotai/revm/pull/2969))
- add SECURITY.md ([#2956](https://github.com/imotai/revm/pull/2956))
- remove duplicate comment for TOTAL_COST_FLOOR_PER_TOKEN constant ([#2950](https://github.com/imotai/revm/pull/2950))
- clean static_selfdestruct_cost ([#2944](https://github.com/imotai/revm/pull/2944))
- rename SELFDESTRUCT to SELFDESTRUCT_REFUND ([#2937](https://github.com/imotai/revm/pull/2937))
