...
## [33.0.0](https://github.com/imotai/revm/compare/revm-interpreter-v32.0.0...revm-interpreter-v33.0.0) - 2026-02-27
...
- *(interpreter)* deduplicate slice range logic ([#3376](https://github.com/imotai/revm/pull/3376))
- remove GPL mention and update gmp feature comments ([#3383](https://github.com/imotai/revm/pull/3383))
- elide some jumps in jump ([#3347](https://github.com/imotai/revm/pull/3347))
- remove outdated stack pop TODO ([#3315](https://github.com/imotai/revm/pull/3315))
