...
## [15.0.0](https://github.com/imotai/revm/compare/revm-statetest-types-v14.0.0...revm-statetest-types-v15.0.0) - 2026-02-27

### Added

- *(statetest-types)* add slot_number support (EIP-7843) ([#3391](https://github.com/imotai/revm/pull/3391))
...
- *(statetest-types)* add BPO2ToAmsterdamAtTime15k fork spec ([#3397](https://github.com/imotai/revm/pull/3397))
