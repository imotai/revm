...
## [9.1.1](https://github.com/imotai/revm/compare/revm-inspector-v9.1.0...revm-inspector-v9.1.1) - 2025-08-13

### Other

- updated the following local packages: revm-database-interface, revm-database, revm-state, revm-context, revm-interpreter, revm-handler
