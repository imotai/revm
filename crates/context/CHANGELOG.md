...
## [13.0.0](https://github.com/imotai/revm/compare/revm-context-v12.1.0...revm-context-v13.0.0) - 2026-01-09
...
- fix API comment ([#3293](https://github.com/imotai/revm/pull/3293))
- *(test)* one gasid name is missing ([#3290](https://github.com/imotai/revm/pull/3290))
- set transaction_id on new account ([#3204](https://github.com/imotai/revm/pull/3204))
...
- add Display trait for ExecutionResult and related types ([#3267](https://github.com/imotai/revm/pull/3267))
- add Display for HaltReason and OutOfGasError ([#3265](https://github.com/imotai/revm/pull/3265))
- *(cleanup)* remove unused duplicate ContextSetters trait in context crate ([#3225](https://github.com/imotai/revm/pull/3225))
