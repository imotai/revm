...
## [9.0.1](https://github.com/imotai/revm/compare/revm-context-interface-v9.0.0...revm-context-interface-v9.0.1) - 2025-07-25

### Fixed

- swapped comments for db and db_mut methods in JournalTr trait ([#2774](https://github.com/imotai/revm/pull/2774))
