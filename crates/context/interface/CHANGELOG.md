...
## [15.0.0](https://github.com/imotai/revm/compare/revm-context-interface-v14.0.0...revm-context-interface-v15.0.0) - 2026-02-27
...
- use provided code hash when setting account code ([#3324](https://github.com/imotai/revm/pull/3324))
