...
## [11.0.0](https://github.com/imotai/revm/compare/revm-context-interface-v10.1.0...revm-context-interface-v11.0.0) - 2025-09-19

### Added

- allow EIP-7623 to be disabled ([#2985](https://github.com/imotai/revm/pull/2985))
- Introduced `all_mut` and `all` functions to ContextTr ([#2992](https://github.com/imotai/revm/pull/2992))
...
- skip cold load on oog ([#2903](https://github.com/imotai/revm/pull/2903))
