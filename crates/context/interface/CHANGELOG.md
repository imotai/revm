...
## [10.0.2](https://github.com/imotai/revm/compare/revm-context-interface-v10.0.1...revm-context-interface-v10.0.2) - 2025-08-13

### Other

- updated the following local packages: revm-database-interface, revm-state
