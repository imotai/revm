...
## [13.1.0](https://github.com/imotai/revm/compare/revm-context-interface-v13.0.0...revm-context-interface-v13.1.0) - 2025-11-13

### Added

- Add set_nonce journal entry and fn ([#3163](https://github.com/imotai/revm/pull/3163))
- *(context)* add mark_cold method to JournaledAccount ([#3160](https://github.com/imotai/revm/pull/3160))
