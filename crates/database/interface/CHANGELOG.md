...
## [7.0.6](https://github.com/imotai/revm/compare/revm-database-interface-v7.0.5...revm-database-interface-v7.0.6) - 2025-10-02
...
- *(database)* extract duplicate test balance constants ([#3017](https://github.com/imotai/revm/pull/3017))
- *(database)* avoid panic by conditionally using block_in_place ([#2927](https://github.com/imotai/revm/pull/2927))
