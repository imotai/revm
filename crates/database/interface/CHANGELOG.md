...
## [7.0.2](https://github.com/imotai/revm/compare/revm-database-interface-v7.0.1...revm-database-interface-v7.0.2) - 2025-07-18

### Other

- impl DatabaseRef for WrapDatabaseRef ([#2726](https://github.com/imotai/revm/pull/2726))
