...
## [10.0.0](https://github.com/imotai/revm/compare/revm-database-v9.0.6...revm-database-v10.0.0) - 2026-01-09

### Added

- *(cache-db)* Added pritty_print for CacheDB ([#3296](https://github.com/imotai/revm/pull/3296))
...
- DatabaseCommitExt::drain_balances ([#3205](https://github.com/imotai/revm/pull/3205))
- DatabaseCommitExt + increment_balances ([#3195](https://github.com/imotai/revm/pull/3195))
- DatabaseCommit::commit_iter ([#3197](https://github.com/imotai/revm/pull/3197))
- Restrict Database::Error. JournaledAccountTr ([#3199](https://github.com/imotai/revm/pull/3199))

### Fixed

- *(database)* return error instead of panic when block not found in AlloyDB ([#3284](https://github.com/imotai/revm/pull/3284))
- *(database)* make DatabaseCommit dyn-compatible ([#3264](https://github.com/imotai/revm/pull/3264))
- *(database)* prevent deadlock in ([#3251](https://github.com/imotai/revm/pull/3251))
- *(database)* verify handle belongs to current runtime before block_in_place ([#3212](https://github.com/imotai/revm/pull/3212))

### Other

- fix typos, grammar errors, and improve documentation consistency ([#3294](https://github.com/imotai/revm/pull/3294))
- fix typos and grammar in database crate ([#3279](https://github.com/imotai/revm/pull/3279))
- happy new year, 2026 licence ([#3272](https://github.com/imotai/revm/pull/3272))
- avoid collect in CacheState commit ([#3242](https://github.com/imotai/revm/pull/3242))
- *(database)* use fixed hashmaps in cache db ([#3231](https://github.com/imotai/revm/pull/3231))
- *(database)* avoid triple cache lookup ([#3232](https://github.com/imotai/revm/pull/3232))
- optimize vector initialization with size hints in state and precompile modules ([#3191](https://github.com/imotai/revm/pull/3191))
