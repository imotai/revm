...
## [9.0.6](https://github.com/imotai/revm/compare/revm-database-v9.0.5...revm-database-v9.0.6) - 2025-11-13

### Fixed

- *(database)* return correct bytecode in BenchmarkDB::code_by_hash ([#3170](https://github.com/imotai/revm/pull/3170))
