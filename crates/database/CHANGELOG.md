...
## [11.0.0](https://github.com/imotai/revm/compare/revm-database-v10.0.0...revm-database-v11.0.0) - 2026-02-27

### Added

- *(database)* add clear() to CacheState and TransitionState ([#3390](https://github.com/imotai/revm/pull/3390))
- *(database)* add iter and lowest helpers to BlockHashCache ([#3352](https://github.com/imotai/revm/pull/3352))
- *(database)* add StateBuilder::with_bal_builder_if ([#3351](https://github.com/imotai/revm/pull/3351))
- *(database)* add storage getter to BundleState ([#3321](https://github.com/imotai/revm/pull/3321))

### Fixed

- forward storage_by_account_id in WrapDatabaseRef ([#3441](https://github.com/imotai/revm/pull/3441))
- *(database)* allow EIP161 state clear for empty Loaded and Changed accounts ([#3421](https://github.com/imotai/revm/pull/3421))
- *(db)* use self.storage() in storage_by_account_id to avoid cache bypass ([#3385](https://github.com/imotai/revm/pull/3385))
- *(bal)* fix populated account if pre-state was none ([#3357](https://github.com/imotai/revm/pull/3357))
- *(database)* BlockHashCache incorrectly returns zero for block 0 ([#3319](https://github.com/imotai/revm/pull/3319))

### Other

- move EIP-161 state clear into journal finalize ([#3444](https://github.com/imotai/revm/pull/3444))
- deduplicate CacheDB::basic by delegating to load_account ([#3447](https://github.com/imotai/revm/pull/3447))
- *(database)* add reserve calls in merge_transitions and extend_state ([#3430](https://github.com/imotai/revm/pull/3430))
- reserve capacity in add_transitions ([#3373](https://github.com/imotai/revm/pull/3373))
- remove GPL mention and update gmp feature comments ([#3383](https://github.com/imotai/revm/pull/3383))
- use fixed bytes hashmaps from alloy-core ([#3358](https://github.com/imotai/revm/pull/3358))
- Use O(1) ring buffer cache for block hashes instead of BTreeMap ([#3299](https://github.com/imotai/revm/pull/3299))
