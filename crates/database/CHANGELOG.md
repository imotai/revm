...
## [7.0.5](https://github.com/imotai/revm/compare/revm-database-v7.0.4...revm-database-v7.0.5) - 2025-08-13

### Other

- *(database)* remove unused dependencies ([#2885](https://github.com/imotai/revm/pull/2885))
- add AccountStatus unit test ([#2869](https://github.com/imotai/revm/pull/2869))
