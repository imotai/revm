...
## [9.0.7](https://github.com/imotai/revm/compare/revm-database-v9.0.6...revm-database-v9.0.7) - 2025-11-20

### Other

- updated the following local packages: revm-primitives, revm-state, revm-database-interface, revm-bytecode
