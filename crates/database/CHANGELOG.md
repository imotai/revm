...
## [7.0.4](https://github.com/imotai/revm/compare/revm-database-v7.0.3...revm-database-v7.0.4) - 2025-08-09

### Other

- use mem::take ([#2870](https://github.com/imotai/revm/pull/2870))
- small performance and safety improvements ([#2868](https://github.com/imotai/revm/pull/2868))
- use HashMap::or_insert_with lazily compute ([#2864](https://github.com/imotai/revm/pull/2864))
