...
## [34.0.0](https://github.com/imotai/revm/compare/revm-v33.0.0...revm-v34.0.0) - 2025-11-13

### Added

- allow EIP-7623 to be disabled ([#2985](https://github.com/imotai/revm/pull/2985))
- [**breaking**] Remove kzg-rs ([#2909](https://github.com/imotai/revm/pull/2909))
- Reuse bls12-381 codepaths to implement kzg point evaluation precompile ([#2809](https://github.com/imotai/revm/pull/2809))
- refactor test utils ([#2813](https://github.com/imotai/revm/pull/2813))
- add system transaction inspection support ([#2808](https://github.com/imotai/revm/pull/2808))
- expose sha3-keccak in revm and revm-primitives ([#2713](https://github.com/imotai/revm/pull/2713))
- optional_eip3541 ([#2661](https://github.com/imotai/revm/pull/2661))
- *(precompile)* rug/gmp-based modexp ([#2596](https://github.com/imotai/revm/pull/2596))
- enable P256 in Osaka ([#2601](https://github.com/imotai/revm/pull/2601))
...
- Reorder revm deps in Cargo.toml ([#2331](https://github.com/imotai/revm/pull/2331))
- Add JournalInner ([#2311](https://github.com/imotai/revm/pull/2311))
- Add a wrapper for arkworks for EIP196 ([#2305](https://github.com/imotai/revm/pull/2305))
...
- push NonceChange to Journal in deduct_caller ([#1804](https://github.com/imotai/revm/pull/1804))
...
- to_plain_state ([#1778](https://github.com/imotai/revm/pull/1778))
- *(example)* deploy bytecode from scratch ([#1767](https://github.com/imotai/revm/pull/1767))
...
- check for typos in CI ([#1686](https://github.com/imotai/revm/pull/1686))
- *(EOF)* EOF Validation add code type and sub container tracker ([#1648](https://github.com/imotai/revm/pull/1648))
- pass interpreter into Inspector::log ([#1610](https://github.com/imotai/revm/pull/1610))
- *(EOF)* Bytecode::new_raw supports EOF, new_raw_checked added ([#1607](https://github.com/imotai/revm/pull/1607))
- use `kzg-rs` for kzg point evaluation ([#1558](https://github.com/imotai/revm/pull/1558))
- add bytecode_address from CallInputs to Contract during construction. ([#1568](https://github.com/imotai/revm/pull/1568))
- *(Prague)* Add EIP-7702 ([#1565](https://github.com/imotai/revm/pull/1565))
- *(EOF)* disallow ExtDelegateCall to legacy bytecode ([#1572](https://github.com/imotai/revm/pull/1572))
- *(EOF)* Add target address expansion checks ([#1570](https://github.com/imotai/revm/pull/1570))
- *(revm)* derive serde for `BundleState` ([#1539](https://github.com/imotai/revm/pull/1539))
- bump alloy, re-enable alloydb ([#1533](https://github.com/imotai/revm/pull/1533))
- mutable access for all fields in BundleBuilder ([#1524](https://github.com/imotai/revm/pull/1524))
- *(EOF)* Put EOF bytecode behind an Arc ([#1517](https://github.com/imotai/revm/pull/1517))
- *(EOF)* EXTCODECOPY,EXTCODESIZE,EXTCODEHASH eof support ([#1504](https://github.com/imotai/revm/pull/1504))
- add helpers for working with instruction tables ([#1493](https://github.com/imotai/revm/pull/1493))
- *(precompiles)* fatal error for precompiles ([#1499](https://github.com/imotai/revm/pull/1499))
- Persist reverted account and storage slot lookups in `JournaledState` ([#1437](https://github.com/imotai/revm/pull/1437))
- *(EOF)* EIP-7698 eof creation transaction ([#1467](https://github.com/imotai/revm/pull/1467))
- *(EOF)* Add EOF to inspector handle register ([#1469](https://github.com/imotai/revm/pull/1469))
- *(optimism)* Implement new L1 cost function for Fjord ([#1420](https://github.com/imotai/revm/pull/1420))
- *(optimism)* Add secp256r1 precompile for Fjord ([#1436](https://github.com/imotai/revm/pull/1436))
- *(revm)* revert EIP-2935 BLOCKHASH opcode changes ([#1450](https://github.com/imotai/revm/pull/1450))
- load account should return db error ([#1447](https://github.com/imotai/revm/pull/1447))
- *(EOF)* remove TXCREATE ([#1415](https://github.com/imotai/revm/pull/1415))
- *(precompile)* Prague - EIP-2537 - BLS12-381 curve operations ([#1389](https://github.com/imotai/revm/pull/1389))
- add a hook to execute individual frames ([#1369](https://github.com/imotai/revm/pull/1369))
- *(Handler)* Add ClearHandle ([#1368](https://github.com/imotai/revm/pull/1368))
- Add uniswap V2 WETH-USDC swap example ([#1353](https://github.com/imotai/revm/pull/1353))
- *(interpreter)* add helpers for spending all gas ([#1360](https://github.com/imotai/revm/pull/1360))
- add helper methods to CallInputs ([#1345](https://github.com/imotai/revm/pull/1345))
- *(revm)* make `FrameOrResult` serializable ([#1282](https://github.com/imotai/revm/pull/1282))
- add flag to force hashbrown usage ([#1284](https://github.com/imotai/revm/pull/1284))
- EOF (Ethereum Object Format) ([#1143](https://github.com/imotai/revm/pull/1143))
- *(`db`)* Introduce `alloydb` ([#1257](https://github.com/imotai/revm/pull/1257))
- *(interpreter)* remove SPEC generic from gas calculation functions ([#1243](https://github.com/imotai/revm/pull/1243))
- *(interpreter)* test Host object-safety, allow `dyn Host` in instructions ([#1245](https://github.com/imotai/revm/pull/1245))
- [**breaking**] TracerEip3155 optionally traces memory ([#1234](https://github.com/imotai/revm/pull/1234))
- add convert_boxed and insert_boxed for InstructionTable ([#1194](https://github.com/imotai/revm/pull/1194))
- optional nonce check ([#1195](https://github.com/imotai/revm/pull/1195))
- Restrict ContextPrecompiles only to EvmContext ([#1174](https://github.com/imotai/revm/pull/1174))
- add insert method on instruction table ([#1167](https://github.com/imotai/revm/pull/1167))
- precompile with generic context ([#1155](https://github.com/imotai/revm/pull/1155))
- use `impl` instead of `dyn` in `GetInspector` ([#1157](https://github.com/imotai/revm/pull/1157))
- add more JournaledState methods to EvmContext ([#1158](https://github.com/imotai/revm/pull/1158))
- add example for using a database by reference ([#1150](https://github.com/imotai/revm/pull/1150))
- Add boxed precompile trait ([#1131](https://github.com/imotai/revm/pull/1131))
- add with_handler method to EvmBuilder ([#1124](https://github.com/imotai/revm/pull/1124))
- bump c-kzg, add portable feature, make it default ([#1106](https://github.com/imotai/revm/pull/1106))
- split off serde_json dependency to its own feature ([#1104](https://github.com/imotai/revm/pull/1104))
- improve OriginalValuesKnown docs ([#1083](https://github.com/imotai/revm/pull/1083))
- *(handler)* Change spec id on &mut ([#1055](https://github.com/imotai/revm/pull/1055))
- *(Handler)* add push and pop of hanler registers ([#1053](https://github.com/imotai/revm/pull/1053))
- tweeks for v4.0 revm release ([#1048](https://github.com/imotai/revm/pull/1048))
- *(op)* Ecotone hardfork ([#1009](https://github.com/imotai/revm/pull/1009))
- *(inspector)* Share call/create inputs in Inspector call_end/create_end ([#1003](https://github.com/imotai/revm/pull/1003))
- Convert optimism panic into graceful error ([#982](https://github.com/imotai/revm/pull/982))
- EvmBuilder and External Contexts ([#888](https://github.com/imotai/revm/pull/888))
- add asm-keccak feature ([#972](https://github.com/imotai/revm/pull/972))
- *(ethersdb)* propagate errors instead of panicking in basic_ref ([#935](https://github.com/imotai/revm/pull/935))
- *(revm)* implement prepend_state for BundleState ([#907](https://github.com/imotai/revm/pull/907))
- add serde derives for `CacheDB` under "serde" flag ([#911](https://github.com/imotai/revm/pull/911))
- *(examples)* generate block traces ([#895](https://github.com/imotai/revm/pull/895))
- *(revm)* Evm Context Tests and test-utils Feature ([#903](https://github.com/imotai/revm/pull/903))
- `Canyon` hardfork behind `optimism` feature flag ([#871](https://github.com/imotai/revm/pull/871))
- Loop call stack ([#851](https://github.com/imotai/revm/pull/851))
- transition account balance delta ([#843](https://github.com/imotai/revm/pull/843))
- *(cfg)* optionally disable beneficiary reward ([#834](https://github.com/imotai/revm/pull/834))
- add more `auto_impl`s to revm traits ([#799](https://github.com/imotai/revm/pull/799))
...
- add methods to `CreateInput` for calculating created address ([#793](https://github.com/imotai/revm/pull/793))
- *(revm)* implement DatabaseRef trait for EthersDB ([#774](https://github.com/imotai/revm/pull/774))
- Alloy primitives ([#724](https://github.com/imotai/revm/pull/724))
- Optimism execution changes ([#682](https://github.com/imotai/revm/pull/682))
- add "kzg" as a separate feature ([#746](https://github.com/imotai/revm/pull/746))
- implement EIP-4844 ([#668](https://github.com/imotai/revm/pull/668))
- *(state)* remove state sorting, no_std ci,remove rayon ([#717](https://github.com/imotai/revm/pull/717))
- return wiped inside storage changeset ([#711](https://github.com/imotai/revm/pull/711))
- *(state)* Nits, builder option and OriginalValueKnown flags ([#699](https://github.com/imotai/revm/pull/699))
- *(StateBuilder)* switch builder option from without_bundle to with_bundle ([#688](https://github.com/imotai/revm/pull/688))
- *(state)* take N reverts from BundleState, struct refactor ([#681](https://github.com/imotai/revm/pull/681))
- add BundleState::revert_latest ([#661](https://github.com/imotai/revm/pull/661))
- *(state)* add a flag allowing transition merge without reverts ([#657](https://github.com/imotai/revm/pull/657))
- *(state)* Make Bundle extend wipe aware ([#655](https://github.com/imotai/revm/pull/655))
- *(state)* ability to disable reverts collection in bundle state ([#654](https://github.com/imotai/revm/pull/654))
- *(`interpreter`)* add hash to bytecode ([#628](https://github.com/imotai/revm/pull/628))
- Optional coinbase tip ([#625](https://github.com/imotai/revm/pull/625))
- *(state)* Use preloaded bundle inside state ([#622](https://github.com/imotai/revm/pull/622))
- *(state)* Block hash cache and overrides ([#621](https://github.com/imotai/revm/pull/621))
...
- EIP-1153 Transient storage opcodes ([#546](https://github.com/imotai/revm/pull/546))
- separate initial checks ([#486](https://github.com/imotai/revm/pull/486))
- Create account checkpoint ([#483](https://github.com/imotai/revm/pull/483))
- Introduce account status as bitflag inside JournalState ([#477](https://github.com/imotai/revm/pull/477))
- Add all internals results to Halt ([#413](https://github.com/imotai/revm/pull/413))
- add contract+target to selfdestruct hook ([#410](https://github.com/imotai/revm/pull/410))
- Add check for chainID ([#393](https://github.com/imotai/revm/pull/393))
- add EVM::with_env ([#385](https://github.com/imotai/revm/pull/385))
...
- Different OutOfGas Error types ([#354](https://github.com/imotai/revm/pull/354))
- revm-interpreter created ([#320](https://github.com/imotai/revm/pull/320))
- allow disabling of balance checks ([#297](https://github.com/imotai/revm/pull/297))
...
- *(revm)* Return `bytes` in Create calls ([#289](https://github.com/imotai/revm/pull/289))
...
- *(refactor)* make keccak in one place. ([#247](https://github.com/imotai/revm/pull/247))
- Migrate `primitive_types::U256` to `ruint::Uint<256, 4>` ([#239](https://github.com/imotai/revm/pull/239))
- allow block gas limit to be toggled off ([#238](https://github.com/imotai/revm/pull/238))
- allow eip3607 to be toggled off ([#237](https://github.com/imotai/revm/pull/237))
- *(revm, revme)* gas inspector ([#222](https://github.com/imotai/revm/pull/222))
- add Memory::shrink_to_fit ([#215](https://github.com/imotai/revm/pull/215))
- expose hash on `BytecodeLocked` ([#189](https://github.com/imotai/revm/pull/189))
- *(revm)* more default trait implementations ([#181](https://github.com/imotai/revm/pull/181))
- Introduce ByteCode format, Update Readme ([#156](https://github.com/imotai/revm/pull/156))
- add Subroutine debug clone derive ([#128](https://github.com/imotai/revm/pull/128))
- add ord derives to specid ([#127](https://github.com/imotai/revm/pull/127))
- add getters for cachedb ([#119](https://github.com/imotai/revm/pull/119))
- add serde support to model types ([#91](https://github.com/imotai/revm/pull/91))
- add some PartialEq derives ([#90](https://github.com/imotai/revm/pull/90))
- `Inspector::log` ([#85](https://github.com/imotai/revm/pull/85))
- mutable call inputs
- call insp end functions on early return
- cache block hashes ([#71](https://github.com/imotai/revm/pull/71))
- implement `DatabaseRef` for `CacheDB`

### Fixed

- expose optional_priority_fee_check feature from context crate ([#3159](https://github.com/imotai/revm/pull/3159))
...
- gas deduction with `disable_balance_check` ([#2699](https://github.com/imotai/revm/pull/2699))
- call stack_frame.clear() at end ([#2656](https://github.com/imotai/revm/pull/2656))
- compare_or_save_testdata sig ([#2637](https://github.com/imotai/revm/pull/2637))
- *(multitx)* Add local flags for create and selfdestruct ([#2581](https://github.com/imotai/revm/pull/2581))
...
- *(precompiles)* add portable flag for bls ([#2174](https://github.com/imotai/revm/pull/2174))
- make macro crate-agnostic ([#1802](https://github.com/imotai/revm/pull/1802))
- *(inspector)* always call selfdestruct if entry is made ([#1746](https://github.com/imotai/revm/pull/1746))
- *(eip7702)* Add tests and fix some bugs ([#1605](https://github.com/imotai/revm/pull/1605))
- correctly calculate eofcreate address ([#1619](https://github.com/imotai/revm/pull/1619))
- allow non-static lifetime in HandleRegisterBox ([#1608](https://github.com/imotai/revm/pull/1608))
- *(EOF)* Use cfg code size limit for eofcreate ([#1606](https://github.com/imotai/revm/pull/1606))
- *(eof)* fixture 2 tests ([#1550](https://github.com/imotai/revm/pull/1550))
- *(eof)* output gas for eofcreate ([#1540](https://github.com/imotai/revm/pull/1540))
- *(revm)* remove storage reset that clears is_cold flag ([#1518](https://github.com/imotai/revm/pull/1518))
- *(op)* Remove `U256::from(<float>)` ([#1498](https://github.com/imotai/revm/pull/1498))
- *(EOF)* panic on empty input range, and continue exec after eofcreate ([#1477](https://github.com/imotai/revm/pull/1477))
- *(Interpreter)* wrong block number used ([#1458](https://github.com/imotai/revm/pull/1458))
- blockchash for devnet-0  ([#1427](https://github.com/imotai/revm/pull/1427))
- *(eip2935)* Preload blockchash storage address ([#1395](https://github.com/imotai/revm/pull/1395))
- return the correct error in resize_memory ([#1359](https://github.com/imotai/revm/pull/1359))
- *(TracerEip3155)* clear Inspector data after transaction. ([#1230](https://github.com/imotai/revm/pull/1230))
- *(GasInspector)* calculate correct remaining gas after call return ([#1236](https://github.com/imotai/revm/pull/1236))
- fix eip3155 summary gas_used bug and add fork name ([#1216](https://github.com/imotai/revm/pull/1216))
- *(revme)* revme error output and remove double summary ([#1169](https://github.com/imotai/revm/pull/1169))
- gas cost calculation ([#1166](https://github.com/imotai/revm/pull/1166))
- reset tstorage on finalize ([#1168](https://github.com/imotai/revm/pull/1168))
- make `feature = "optional_gas_refund"` work ([#1134](https://github.com/imotai/revm/pull/1134))
- replace tuple in sstore return with struct ([#1115](https://github.com/imotai/revm/pull/1115))
- fix EthersDB deadlock ([#1089](https://github.com/imotai/revm/pull/1089))
- Handle fatal db error on load_account ([#1111](https://github.com/imotai/revm/pull/1111))
- rename and pass optimism-default-handler to revm-primitives ([#1098](https://github.com/imotai/revm/pull/1098))
- modify cfg spec_id ([#1095](https://github.com/imotai/revm/pull/1095)) ([#1096](https://github.com/imotai/revm/pull/1096))
- optimism compilation ([#1091](https://github.com/imotai/revm/pull/1091))
- properly set context env ([#1070](https://github.com/imotai/revm/pull/1070))
- typo on internal append_handle_register methods ([#1069](https://github.com/imotai/revm/pull/1069))
- *(op)* skip validation on deposit tx ([#1065](https://github.com/imotai/revm/pull/1065))
- fix previous commit ([#1044](https://github.com/imotai/revm/pull/1044))
- *(State)* Preserve original values on delete revert ([#1010](https://github.com/imotai/revm/pull/1010))
- optimism gas refunds ([#989](https://github.com/imotai/revm/pull/989))
- dont calculate initcode keccak on CREATE ([#969](https://github.com/imotai/revm/pull/969))
- *(ci)* Workflow Touchups ([#901](https://github.com/imotai/revm/pull/901))
- safer stack ([#879](https://github.com/imotai/revm/pull/879))
- *(op)* Base Goerli `op-reth` sync patches ([#824](https://github.com/imotai/revm/pull/824))
- fix typos in revm crate ([#821](https://github.com/imotai/revm/pull/821))
- Optimism execution ([#789](https://github.com/imotai/revm/pull/789))
- rename `DatabaseRef` trait functions to `*_ref` ([#795](https://github.com/imotai/revm/pull/795))
- use u128 for calc data fee result ([#757](https://github.com/imotai/revm/pull/757))
- *(eip4844)* Pass eth tests, additional conditions added. ([#735](https://github.com/imotai/revm/pull/735))
- use CANCUN precompile id for CANCUN SpecId ([#733](https://github.com/imotai/revm/pull/733))
- *(state)* Extend now properly transfers wiped storage ([#675](https://github.com/imotai/revm/pull/675))
- *(state)* retain destroyed account status on bundle extend ([#667](https://github.com/imotai/revm/pull/667))
- *(state)* Regresion, remove present info on selfdestruct ([#664](https://github.com/imotai/revm/pull/664))
- *(state)* state transition regression ([#662](https://github.com/imotai/revm/pull/662))
- *(state)* drop storage only for DestroyedChanged ([#651](https://github.com/imotai/revm/pull/651))
- fix revert from DestroyedChanged to DestroyedAgain ([#648](https://github.com/imotai/revm/pull/648))
- *(state)* check if storage revert is empty ([#643](https://github.com/imotai/revm/pull/643))
- *(state)* return RevertToSlot struct with more info ([#636](https://github.com/imotai/revm/pull/636))
- fix typos ([#620](https://github.com/imotai/revm/pull/620))
- *(inspector)* call call_end/create_end when inspector shortcircuits calls ([#609](https://github.com/imotai/revm/pull/609))
- Load caller in safe way in finalization fn ([#604](https://github.com/imotai/revm/pull/604))
- *(transient_storage)* set previous value in journal ([#585](https://github.com/imotai/revm/pull/585))
- AccessList with two same addresses ([#578](https://github.com/imotai/revm/pull/578))
- *(revm)* EIP-3155 tracer tx output without debug artefact ([#552](https://github.com/imotai/revm/pull/552))
- *(revm)* extra return in EIP3155 inspector ([#563](https://github.com/imotai/revm/pull/563))
- *(revm)* include CREATE/CREATE2 in EIP3155 inspector ([#562](https://github.com/imotai/revm/pull/562))
- *(doc)* Inline documentation of re-exports ([#560](https://github.com/imotai/revm/pull/560))
- fix comment ([#529](https://github.com/imotai/revm/pull/529))
- typo in eip-3155 output ([#497](https://github.com/imotai/revm/pull/497))
- revert of selfdestruct with same target address ([#475](https://github.com/imotai/revm/pull/475))
- compile errors for features ([#467](https://github.com/imotai/revm/pull/467))
- touched account on creation ([#463](https://github.com/imotai/revm/pull/463))
- k256 compile error ([#451](https://github.com/imotai/revm/pull/451))
- *(db)* preserve existing account state ([#414](https://github.com/imotai/revm/pull/414))
- call create_end for all code paths ([#362](https://github.com/imotai/revm/pull/362))
- disable balance check ([#342](https://github.com/imotai/revm/pull/342))
- feature flags ([#330](https://github.com/imotai/revm/pull/330))
- broken feature flags ([#319](https://github.com/imotai/revm/pull/319))
- feature flag compiler errors ([#256](https://github.com/imotai/revm/pull/256))
- fix web3db sanity check ([#245](https://github.com/imotai/revm/pull/245))
- return out of gas code for precompiled contracts ([#234](https://github.com/imotai/revm/pull/234))
- make DatabaseRef::basic consistent with Database ([#201](https://github.com/imotai/revm/pull/201))
- Use `saturating_add` instead of `checked_add` in `finalize` ([#184](https://github.com/imotai/revm/pull/184))
- *(revm)* Fix balance overflow in `finalize` ([#182](https://github.com/imotai/revm/pull/182))
- set gas_block to empty bytecode ([#172](https://github.com/imotai/revm/pull/172))
- BLOCKHASH should return 0 if number not in last 256 blocks ([#112](https://github.com/imotai/revm/pull/112))
...
- forward optional_fee_charge feature ([#3005](https://github.com/imotai/revm/pull/3005))
...
- rm ee-test from revm/op-revm ([#2857](https://github.com/imotai/revm/pull/2857))
...
- reuse global crypto provide idea ([#2786](https://github.com/imotai/revm/pull/2786))
...
- add asm-sha2 feature for sha2 precompile ([#2712](https://github.com/imotai/revm/pull/2712))
...
- inline documentation of revm top modules ([#2666](https://github.com/imotai/revm/pull/2666))
...
- changelog tag v70, revm v23.0.0 ([#2488](https://github.com/imotai/revm/pull/2488))
- release ([#2487](https://github.com/imotai/revm/pull/2487))
- typos ([#2474](https://github.com/imotai/revm/pull/2474))
...
- Propagate asyncdb feature flag from database-interface to revm  ([#2310](https://github.com/imotai/revm/pull/2310))
...
- examples to use main revm crate ([#2152](https://github.com/imotai/revm/pull/2152))
...
- remove `optional_gas_refund` as unused ([#2132](https://github.com/imotai/revm/pull/2132))
...
- backport op l1 fetch perf ([#2076](https://github.com/imotai/revm/pull/2076))
- API cleanup ([#2067](https://github.com/imotai/revm/pull/2067))
- Add helpers with_inspector with_precompile ([#2063](https://github.com/imotai/revm/pull/2063))
- Bump licence year to 2025 ([#2058](https://github.com/imotai/revm/pull/2058))
- bump alloy versions to match latest ([#2007](https://github.com/imotai/revm/pull/2007))
...
- EVM transact, make output generic for POSTEXEC ([#1931](https://github.com/imotai/revm/pull/1931))
...
- bumps select alloy crates to 0.6 ([#1854](https://github.com/imotai/revm/pull/1854))
- Update README.md examples section ([#1853](https://github.com/imotai/revm/pull/1853))
- some no_std cleanup ([#1834](https://github.com/imotai/revm/pull/1834))
- bump alloy to 0.4.2 ([#1817](https://github.com/imotai/revm/pull/1817))
- *(primitives)* replace HashMap re-exports with alloy_primitives::map ([#1805](https://github.com/imotai/revm/pull/1805))
- *(deps)* bump anyhow from 1.0.88 to 1.0.89 ([#1772](https://github.com/imotai/revm/pull/1772))
- simplify SuccessOrHalt trait bound ([#1768](https://github.com/imotai/revm/pull/1768))
- *(deps)* bump alloy-sol-types from 0.8.0 to 0.8.2 ([#1762](https://github.com/imotai/revm/pull/1762))
- *(deps)* bump anyhow from 1.0.86 to 1.0.87 ([#1760](https://github.com/imotai/revm/pull/1760))
- make clippy happy ([#1755](https://github.com/imotai/revm/pull/1755))
- Test l1 gas used fjord ([#1749](https://github.com/imotai/revm/pull/1749))
- Add test for `revm::optimism::L1BlockInfo::calculate_tx_l1_cost_fjord` ([#1743](https://github.com/imotai/revm/pull/1743))
- *(deps)* bump tokio from 1.39.2 to 1.40.0 ([#1739](https://github.com/imotai/revm/pull/1739))
- release ([#1729](https://github.com/imotai/revm/pull/1729))
- Bump new logo ([#1735](https://github.com/imotai/revm/pull/1735))
- main changelog ([#1730](https://github.com/imotai/revm/pull/1730))
- release ([#1722](https://github.com/imotai/revm/pull/1722))
- *(deps)* bump alloy and primitives ([#1725](https://github.com/imotai/revm/pull/1725))
- cast block number to u64 and not usize ([#1727](https://github.com/imotai/revm/pull/1727))
- clean up some journalstate docs ([#1712](https://github.com/imotai/revm/pull/1712))
- update some docs related to state ([#1711](https://github.com/imotai/revm/pull/1711))
- tag v41 revm v13.0.0 ([#1692](https://github.com/imotai/revm/pull/1692))
- release ([#1683](https://github.com/imotai/revm/pull/1683))
- Add OP-Granite hardfork, limiting bn256Pairing input size ([#1685](https://github.com/imotai/revm/pull/1685))
- *(deps)* bump rstest from 0.21.0 to 0.22.0 ([#1681](https://github.com/imotai/revm/pull/1681))
- *(deps)* bump tokio from 1.38.1 to 1.39.2 ([#1668](https://github.com/imotai/revm/pull/1668))
- *(clippy)* 1.80 rust clippy list paragraph ident ([#1661](https://github.com/imotai/revm/pull/1661))
- avoid cloning original_bytes ([#1646](https://github.com/imotai/revm/pull/1646))
- use `is_zero` for `U256` and `B256` ([#1638](https://github.com/imotai/revm/pull/1638))
- fix some typos & remove useless Arc::clone ([#1621](https://github.com/imotai/revm/pull/1621))
- *(eof)* simplify magic checks ([#1633](https://github.com/imotai/revm/pull/1633))
- bump versions bcs of primitives ([#1631](https://github.com/imotai/revm/pull/1631))
- bump main changelog ([#1630](https://github.com/imotai/revm/pull/1630))
- *(EOF)* Use Bytecode::new_legacy ([#1628](https://github.com/imotai/revm/pull/1628))
- release ([#1620](https://github.com/imotai/revm/pull/1620))
- bump alloy deps ([#1623](https://github.com/imotai/revm/pull/1623))
- *(deps)* bump alloy-sol-types from 0.7.6 to 0.7.7 ([#1614](https://github.com/imotai/revm/pull/1614))
- group optimism invalid txn errors ([#1604](https://github.com/imotai/revm/pull/1604))
- load_account -> warm_preloaded_addresses ([#1584](https://github.com/imotai/revm/pull/1584))
- Refactor code, and check if precompile for create collision ([#1600](https://github.com/imotai/revm/pull/1600))
- *(revm)* defer bytecode load ([#1588](https://github.com/imotai/revm/pull/1588))
- Rename gas_price to gas_limit for precompile args ([#1593](https://github.com/imotai/revm/pull/1593))
- release ([#1579](https://github.com/imotai/revm/pull/1579))
- bump precompile to v9.0.0 ([#1590](https://github.com/imotai/revm/pull/1590))
- *(README)* add rbuilder to used-by ([#1585](https://github.com/imotai/revm/pull/1585))
- Use HandleOrRuntime to allow alloydb/ethersdb to hold a custom runtime ([#1576](https://github.com/imotai/revm/pull/1576))
- store tokio::runtime::Handle in ethers/alloyDB ([#1557](https://github.com/imotai/revm/pull/1557))
- use const blocks ([#1522](https://github.com/imotai/revm/pull/1522))
- fix compile for alloydb ([#1559](https://github.com/imotai/revm/pull/1559))
- replace AccessList with alloy version ([#1552](https://github.com/imotai/revm/pull/1552))
- replace U256 with u64 in BLOCKHASH ([#1505](https://github.com/imotai/revm/pull/1505))
- release ([#1548](https://github.com/imotai/revm/pull/1548))
- Add CI build target for no-std + optimism, use matrix builds ([#1551](https://github.com/imotai/revm/pull/1551))
- replace TransactTo with TxKind ([#1542](https://github.com/imotai/revm/pull/1542))
- avoid cloning precompiles ([#1486](https://github.com/imotai/revm/pull/1486))
- add setters to `BundleBuilder` with `&mut self` ([#1527](https://github.com/imotai/revm/pull/1527))
- pluralize EOFCreateInput ([#1523](https://github.com/imotai/revm/pull/1523))
- added simular to used-by ([#1521](https://github.com/imotai/revm/pull/1521))
- Removed .clone() in ExecutionHandler::call, and reusing output buffer in Interpreter ([#1512](https://github.com/imotai/revm/pull/1512))
- remove old deprecated items ([#1489](https://github.com/imotai/revm/pull/1489))
- *(deps)* bump rstest from 0.19.0 to 0.21.0 ([#1482](https://github.com/imotai/revm/pull/1482))
- *(deps)* bump tokio from 1.37.0 to 1.38.0 ([#1480](https://github.com/imotai/revm/pull/1480))
- *(primitives)* rename State/Storage to EvmState/EvmStorage ([#1459](https://github.com/imotai/revm/pull/1459))
- remove 'checked' bytecode bench causing benchmarks to crash due to name ([#1461](https://github.com/imotai/revm/pull/1461))
- cargo update ([#1451](https://github.com/imotai/revm/pull/1451))
- cleanup host blockhash fn ([#1430](https://github.com/imotai/revm/pull/1430))
- Revert "Revert "feat: implement EIP-2935 ([#1354](https://github.com/imotai/revm/pull/1354))" ([#1424](https://github.com/imotai/revm/pull/1424))" ([#1426](https://github.com/imotai/revm/pull/1426))
- Revert "feat: implement EIP-2935 ([#1354](https://github.com/imotai/revm/pull/1354))" ([#1424](https://github.com/imotai/revm/pull/1424))
- *(deps)* bump anyhow from 1.0.82 to 1.0.83 ([#1404](https://github.com/imotai/revm/pull/1404))
- remove alloydb example as the crate is not published ([#1398](https://github.com/imotai/revm/pull/1398))
- release ([#1261](https://github.com/imotai/revm/pull/1261))
- add Trin to used by list ([#1393](https://github.com/imotai/revm/pull/1393))
- refactor lints ([#1386](https://github.com/imotai/revm/pull/1386))
- bump alloy & specify dep rev ([#1380](https://github.com/imotai/revm/pull/1380))
- *(interpreter)* branch less in as_usize_or_fail ([#1374](https://github.com/imotai/revm/pull/1374))
- *(ci)* bump action/deploy ([#1372](https://github.com/imotai/revm/pull/1372))
- shrink OpCodeInfo and add more methods ([#1307](https://github.com/imotai/revm/pull/1307))
- *(deps)* bump anyhow from 1.0.81 to 1.0.82 ([#1293](https://github.com/imotai/revm/pull/1293))
- fix some warnings ([#1305](https://github.com/imotai/revm/pull/1305))
- Update documentation ([#1275](https://github.com/imotai/revm/pull/1275))
- *(interpreter)* use `pop_top!` where possible ([#1267](https://github.com/imotai/revm/pull/1267))
- add and use EvmContext::take_error ([#1264](https://github.com/imotai/revm/pull/1264))
...
- *(deps)* bump tokio from 1.36.0 to 1.37.0 ([#1244](https://github.com/imotai/revm/pull/1244))
- *(interpreter)* unbox contract field ([#1228](https://github.com/imotai/revm/pull/1228))
- *(primitives)* kzg intro ([#1209](https://github.com/imotai/revm/pull/1209))
- *(interpreter)* keep track of remaining gas rather than spent ([#1221](https://github.com/imotai/revm/pull/1221))
- Improve `EthersDB` ([#1208](https://github.com/imotai/revm/pull/1208))
- Revert "feat: optional nonce check ([#1195](https://github.com/imotai/revm/pull/1195))" ([#1212](https://github.com/imotai/revm/pull/1212))
- release ([#1175](https://github.com/imotai/revm/pull/1175))
- Change unwrap to ? to propagate errors ([#1207](https://github.com/imotai/revm/pull/1207))
- fix wonky test ([#1197](https://github.com/imotai/revm/pull/1197))
- clippy ([#1196](https://github.com/imotai/revm/pull/1196))
- *(deps)* bump anyhow from 1.0.80 to 1.0.81 ([#1187](https://github.com/imotai/revm/pull/1187))
- fix some typos ([#1189](https://github.com/imotai/revm/pull/1189))
- Fix typo in readme ([#1185](https://github.com/imotai/revm/pull/1185))
- Update post_execution.rs ([#1180](https://github.com/imotai/revm/pull/1180))
- tag v32 revm v7.1.0 ([#1176](https://github.com/imotai/revm/pull/1176))
- release ([#1125](https://github.com/imotai/revm/pull/1125))
- *(deps)* bump ethers-contract from 2.0.13 to 2.0.14 ([#1161](https://github.com/imotai/revm/pull/1161))
- Add Hardhat to the "Used by" list ([#1164](https://github.com/imotai/revm/pull/1164))
- *(interpreter)* evaluate instruction table constructor at compile time ([#1140](https://github.com/imotai/revm/pull/1140))
- Add VERBS to used by list ([#1141](https://github.com/imotai/revm/pull/1141))
- remove clone for context in handler_register.rs ([#1138](https://github.com/imotai/revm/pull/1138))
- Check runtime dynamically ([#1135](https://github.com/imotai/revm/pull/1135))
- *(deps)* bump auto_impl from 1.1.2 to 1.2.0 ([#1132](https://github.com/imotai/revm/pull/1132))
- Add `db` and `db_mut` to evm ([#1133](https://github.com/imotai/revm/pull/1133))
- add ToString for no_std add exports some types in no_std ([#1128](https://github.com/imotai/revm/pull/1128))
- Add `clone` method to `ContextWithHandlerCfg` ([#1127](https://github.com/imotai/revm/pull/1127))
- remove unused EvmInstructionTables type alias ([#1123](https://github.com/imotai/revm/pull/1123))
- release tag v30 revm v6.1.0 ([#1100](https://github.com/imotai/revm/pull/1100))
- Ensure `L1Block` is in the cache ([#1121](https://github.com/imotai/revm/pull/1121))
- Fix feature name for generate_block_traces example ([#1120](https://github.com/imotai/revm/pull/1120))
- *(refactor)* Propagate fatal error ([#1116](https://github.com/imotai/revm/pull/1116))
- Revert "fix EthersDB deadlock ([#1089](https://github.com/imotai/revm/pull/1089))" ([#1118](https://github.com/imotai/revm/pull/1118))
- Remove DatabaseRef bound on CacheDB ([#1113](https://github.com/imotai/revm/pull/1113))
- clippy cleanup ([#1112](https://github.com/imotai/revm/pull/1112))
- *(deps)* bump anyhow from 1.0.79 to 1.0.80 ([#1108](https://github.com/imotai/revm/pull/1108))
- improve EIP-3155 implementation ([#1105](https://github.com/imotai/revm/pull/1105))
- release ([#1082](https://github.com/imotai/revm/pull/1082))
- *(state)* avoid cloning full account ([#1097](https://github.com/imotai/revm/pull/1097))
- *(precompile)* use `Bytes` in precompile functions ([#1085](https://github.com/imotai/revm/pull/1085))
- Add memory offset ([#1032](https://github.com/imotai/revm/pull/1032))
...
- *(precompile)* make use of padding utilities, simplify secp256k1 ([#1073](https://github.com/imotai/revm/pull/1073))
- *(revm)* Add helpers to Build Revm with Context ([#1068](https://github.com/imotai/revm/pull/1068))
...
- bump c-kzg and enable blst portable feature ([#1059](https://github.com/imotai/revm/pull/1059))
- spelling on last commit ([#1058](https://github.com/imotai/revm/pull/1058))
- helper functions around Env ([#1057](https://github.com/imotai/revm/pull/1057))
- *(deps)* bump tokio from 1.35.1 to 1.36.0 ([#1052](https://github.com/imotai/revm/pull/1052))
- *(EvmBuilder)* rename builder functions to HandlerCfg ([#1050](https://github.com/imotai/revm/pull/1050))
- *(deps)* bump ethers-contract from 2.0.11 to 2.0.13 ([#1034](https://github.com/imotai/revm/pull/1034))
- *(std)* Add std HashMap,HashSet ([#1041](https://github.com/imotai/revm/pull/1041))
- group handlers ([#1030](https://github.com/imotai/revm/pull/1030))
- *(Inspector)* add inspector depth test ([#1028](https://github.com/imotai/revm/pull/1028))
- *(op)* Move op l1 block load to op handler ([#1026](https://github.com/imotai/revm/pull/1026))
- *(clippy)* nightly clippy ([#1025](https://github.com/imotai/revm/pull/1025))
- *(Execution)* Granular handles create/call,call_return,insert_call_outcome ([#1024](https://github.com/imotai/revm/pull/1024))
- *(Inspector)* Add return_memory_offset to Inspector::call ([#1006](https://github.com/imotai/revm/pull/1006))
- update call end docs ([#1000](https://github.com/imotai/revm/pull/1000))
- add getter for specId ([#998](https://github.com/imotai/revm/pull/998))
- Remove preserve_order in serde_json ([#997](https://github.com/imotai/revm/pull/997))
- update create docs ([#999](https://github.com/imotai/revm/pull/999))
- *(revme)* EmptyDb Blockhash string, json-outcome flag, set prevrandao in statetest ([#994](https://github.com/imotai/revm/pull/994))
- *(Inspector)* add CallOutcome to call/call_end ([#985](https://github.com/imotai/revm/pull/985))
- set deduct_caller in optimism handler ([#988](https://github.com/imotai/revm/pull/988))
- fix serde std flags for no-std build ([#987](https://github.com/imotai/revm/pull/987))
- *(Inspector)* Add CreateOutcome in create/create_end return ([#980](https://github.com/imotai/revm/pull/980))
- *(log)* use alloy_primitives::Log ([#975](https://github.com/imotai/revm/pull/975))
- *(EvmBuilder)* Remove unnecessary BuilderStage trait ([#979](https://github.com/imotai/revm/pull/979))
- enhance readability ([#968](https://github.com/imotai/revm/pull/968))
- *(interpreter)* refactor sstore_cost ([#974](https://github.com/imotai/revm/pull/974))
- *(interpreter)* improve enum naming ([#962](https://github.com/imotai/revm/pull/962))
- *(deps)* bump anyhow from 1.0.77 to 1.0.79 ([#950](https://github.com/imotai/revm/pull/950))
- relax Bytes requirement and use slice instead ([#937](https://github.com/imotai/revm/pull/937))
- *(deps)* bump futures from 0.3.29 to 0.3.30 ([#927](https://github.com/imotai/revm/pull/927))
- *(deps)* bump anyhow from 1.0.75 to 1.0.76 ([#921](https://github.com/imotai/revm/pull/921))
- *(deps)* bump tokio from 1.34.0 to 1.35.0 ([#909](https://github.com/imotai/revm/pull/909))
- *(docs)* Update the benchmark docs to point to revm package ([#906](https://github.com/imotai/revm/pull/906))
- *(revm)* leverage StorageSlot methods, where appropriate ([#899](https://github.com/imotai/revm/pull/899))
- *(docs)* Update top-level benchmark docs ([#894](https://github.com/imotai/revm/pull/894))
- relax state generic ([#881](https://github.com/imotai/revm/pull/881))
- clippy ([#877](https://github.com/imotai/revm/pull/877))
- *(deps)* bump ethers-contract from 2.0.10 to 2.0.11 ([#867](https://github.com/imotai/revm/pull/867))
- bump k256 and use normalize_s ([#870](https://github.com/imotai/revm/pull/870))
- simplify use statements ([#864](https://github.com/imotai/revm/pull/864))
- Fix error message for LackOfFundForMaxFee ([#858](https://github.com/imotai/revm/pull/858))
- Fix rustdoc warnings ([#859](https://github.com/imotai/revm/pull/859))
- *(deps)* bump tokio from 1.33.0 to 1.34.0 ([#856](https://github.com/imotai/revm/pull/856))
- change addresses to iterator and add into_addresses ([#855](https://github.com/imotai/revm/pull/855))
- use keccak256 for blockhash ([#854](https://github.com/imotai/revm/pull/854))
- review safety comments ([#811](https://github.com/imotai/revm/pull/811))
- *(deps)* bump futures from 0.3.28 to 0.3.29 ([#839](https://github.com/imotai/revm/pull/839))
- *(state)* consistent selfdestruct status transition ([#847](https://github.com/imotai/revm/pull/847))
- *(state)* move account status transitions to `AccountStatus` ([#844](https://github.com/imotai/revm/pull/844))
- *(state)* simplify control flow in `CacheState::apply_evm_state` ([#842](https://github.com/imotai/revm/pull/842))
- Refactor precompile list from Hash to vec ([#823](https://github.com/imotai/revm/pull/823))
- *(state)* make `State::apply_transition` pub ([#832](https://github.com/imotai/revm/pull/832))
- *(state)* make bundle state non-optional ([#828](https://github.com/imotai/revm/pull/828))
- Refactor evm data to its file ([#815](https://github.com/imotai/revm/pull/815))
- for now support 1.69 rust compiler ([#814](https://github.com/imotai/revm/pull/814))
- refactor main return to handle ([#808](https://github.com/imotai/revm/pull/808))
- *(SharedMemory)* small refactor; tests ([#806](https://github.com/imotai/revm/pull/806))
- use `array::from_fn` in `make_instruction_table` ([#809](https://github.com/imotai/revm/pull/809))
- remove `step` and `step_end` return result ([#804](https://github.com/imotai/revm/pull/804))
- Instruction table ([#759](https://github.com/imotai/revm/pull/759))
- getter for  field of ([#792](https://github.com/imotai/revm/pull/792))
- Shared memory between calls ([#673](https://github.com/imotai/revm/pull/673))
- Fix typos ([#790](https://github.com/imotai/revm/pull/790))
- *(deps)* bump tokio from 1.32.0 to 1.33.0 ([#785](https://github.com/imotai/revm/pull/785))
- clang requirement ([#784](https://github.com/imotai/revm/pull/784))
- Use upstream create and create2 implementations ([#775](https://github.com/imotai/revm/pull/775))
- reorder JournalState impl ([#772](https://github.com/imotai/revm/pull/772))
- document everything, dedup existing docs ([#741](https://github.com/imotai/revm/pull/741))
- bump v26 revm v3.5.0 ([#765](https://github.com/imotai/revm/pull/765))
- document non-zero amounts in State::increment_balances ([#760](https://github.com/imotai/revm/pull/760))
- tag v25, revm v3.4.0 ([#755](https://github.com/imotai/revm/pull/755))
- Readme Updates ([#756](https://github.com/imotai/revm/pull/756))
- Improve wording and fix typos ([#749](https://github.com/imotai/revm/pull/749))
- say "warm" instead of "hot" ([#754](https://github.com/imotai/revm/pull/754))
- Logo ([#743](https://github.com/imotai/revm/pull/743))
- SELFDESTRUCT only in same transaction ([#719](https://github.com/imotai/revm/pull/719))
- error type for block header ([#731](https://github.com/imotai/revm/pull/731))
- refactor interpreter internals and cleanup ([#582](https://github.com/imotai/revm/pull/582))
- make BundleBuilder publicly available ([#729](https://github.com/imotai/revm/pull/729))
- *(perf)* only recalc code hash if its the default ([#716](https://github.com/imotai/revm/pull/716))
- add warning on panic conditions in take_bundle ([#715](https://github.com/imotai/revm/pull/715))
...
- *(deps)* bump ethers-contract from 2.0.9 to 2.0.10 ([#705](https://github.com/imotai/revm/pull/705))
- *(state)* do not insert empty reverts in state ([#702](https://github.com/imotai/revm/pull/702))
- implement `Default` for other databases ([#691](https://github.com/imotai/revm/pull/691))
- make `impl Default for StateBuilder` generic ([#690](https://github.com/imotai/revm/pull/690))
- bundle size hint ([#670](https://github.com/imotai/revm/pull/670))
- deprecate `RefDBWrapper` ([#696](https://github.com/imotai/revm/pull/696))
- expose StateDBBox ([#694](https://github.com/imotai/revm/pull/694))
- *(state)* Make Database more generic. ([#687](https://github.com/imotai/revm/pull/687))
- nits and renamings ([#684](https://github.com/imotai/revm/pull/684))
- apply builder pattern for BundleState initialization ([#649](https://github.com/imotai/revm/pull/649))
- impl Eq, PartialEq for TransitionState ([#677](https://github.com/imotai/revm/pull/677))
- Removed the last dependencies breaking no-std build. ([#669](https://github.com/imotai/revm/pull/669))
- *(state)* bundle retention ([#666](https://github.com/imotai/revm/pull/666))
- *(deps)* bump ethers-contract from 2.0.8 to 2.0.9 ([#640](https://github.com/imotai/revm/pull/640))
- filter out empty bytecode from bundle ([#656](https://github.com/imotai/revm/pull/656))
- *(state)* bundle state split ([#646](https://github.com/imotai/revm/pull/646))
- add value parameter to Inspector::selfdestruct ([#645](https://github.com/imotai/revm/pull/645))
- Split transaction pre verification to separate function ([#573](https://github.com/imotai/revm/pull/573))
- *(state)* bundle selfdestructs ([#627](https://github.com/imotai/revm/pull/627))
- misc improvements ([#633](https://github.com/imotai/revm/pull/633))
- bundle state ([#637](https://github.com/imotai/revm/pull/637))
- *(state)* remove redundunt info revert on destruct ([#635](https://github.com/imotai/revm/pull/635))
- book workflow ([#537](https://github.com/imotai/revm/pull/537))
- *(state)* bundle reverts collapse ([#626](https://github.com/imotai/revm/pull/626))
- Revert "feat: alloy migration ([#535](https://github.com/imotai/revm/pull/535))" ([#616](https://github.com/imotai/revm/pull/616))
- *(state)* account & storage revert value preservation ([#614](https://github.com/imotai/revm/pull/614))
- spell check ([#615](https://github.com/imotai/revm/pull/615))
- get or insert bundle state ([#613](https://github.com/imotai/revm/pull/613))
- *(deps)* bump anyhow from 1.0.74 to 1.0.75 ([#606](https://github.com/imotai/revm/pull/606))
- *(deps)* bump tokio from 1.31.0 to 1.32.0 ([#607](https://github.com/imotai/revm/pull/607))
- export some `unreachable_pub` items ([#598](https://github.com/imotai/revm/pull/598))
- *(deps)* bump anyhow from 1.0.72 to 1.0.74 ([#602](https://github.com/imotai/revm/pull/602))
- fix test build, use new types ([#605](https://github.com/imotai/revm/pull/605))
- Revert test, not change storage check , renaming of original slot value ([#601](https://github.com/imotai/revm/pull/601))
- `TransitionState::with_capacity` -> `TransitionState::single` ([#600](https://github.com/imotai/revm/pull/600))
- pre-allocate inner bundle state ([#599](https://github.com/imotai/revm/pull/599))
- avoid unnecessary allocations ([#581](https://github.com/imotai/revm/pull/581))
- *(deps)* bump tokio from 1.29.1 to 1.31.0 ([#595](https://github.com/imotai/revm/pull/595))
- move precompiles to EVMData for inspectors ([#588](https://github.com/imotai/revm/pull/588))
- rewrite revm-test as a criterion bench ([#579](https://github.com/imotai/revm/pull/579))
...
- consume all gas on invalid opcode ([#500](https://github.com/imotai/revm/pull/500))
- *(deps)* bump auto_impl from 1.0.1 to 1.1.0 ([#478](https://github.com/imotai/revm/pull/478))
- fix comment typo ([#517](https://github.com/imotai/revm/pull/517))
- add some CacheDB docs ([#484](https://github.com/imotai/revm/pull/484))
- refactor interpreter run and remove static flag ([#481](https://github.com/imotai/revm/pull/481))
- Bundle inspector crate/call calls ([#480](https://github.com/imotai/revm/pull/480))
- Bump v24, revm v3.3.0 ([#476](https://github.com/imotai/revm/pull/476))
- *(deps)* bump tokio from 1.27.0 to 1.28.0 ([#470](https://github.com/imotai/revm/pull/470))
- *(deps)* bump anyhow from 1.0.70 to 1.0.71 ([#471](https://github.com/imotai/revm/pull/471))
...
- typos ([#448](https://github.com/imotai/revm/pull/448))
- v21, revm v3.1.0 ([#444](https://github.com/imotai/revm/pull/444))
- bump all
- ethers to v2.0
- Improve EthersDB::new ([#440](https://github.com/imotai/revm/pull/440))
- add feature for ignoring base fee check ([#436](https://github.com/imotai/revm/pull/436))
- Update README.md ([#424](https://github.com/imotai/revm/pull/424))
- *(deps)* bump futures from 0.3.26 to 0.3.27 ([#416](https://github.com/imotai/revm/pull/416))
- enabled primtive default feature in precompile ([#409](https://github.com/imotai/revm/pull/409))
- fix typo StorageChange ([#403](https://github.com/imotai/revm/pull/403))
- *(deps)* bump tokio from 1.25.0 to 1.26.0 ([#395](https://github.com/imotai/revm/pull/395))
- remove gas blocks ([#391](https://github.com/imotai/revm/pull/391))
- impl NonceTooHigh/ NonceTooLow checks ([#383](https://github.com/imotai/revm/pull/383))
- fix compilation if serde not enabled ([#381](https://github.com/imotai/revm/pull/381))
- add no_std to primitives ([#366](https://github.com/imotai/revm/pull/366))
- *(deps)* bump tokio from 1.24.2 to 1.25.0 ([#352](https://github.com/imotai/revm/pull/352))
- *(deps)* bump futures from 0.3.25 to 0.3.26 ([#353](https://github.com/imotai/revm/pull/353))
- rename Then to Than ([#368](https://github.com/imotai/revm/pull/368))
- add error details to InvalidTransaction::LackOfFundForGasLimit ([#364](https://github.com/imotai/revm/pull/364))
- Use gas price in place of effective gas price for initial balance check ([#359](https://github.com/imotai/revm/pull/359))
...
- add logs & return value to revert ([#343](https://github.com/imotai/revm/pull/343))
...
- mark `with-serde` feature as deprecated ([#328](https://github.com/imotai/revm/pull/328))
- add Eq to AccountState ([#326](https://github.com/imotai/revm/pull/326))
- make load_account pub ([#325](https://github.com/imotai/revm/pull/325))
- Cleanup, move hot fields toggether in Interpreter ([#321](https://github.com/imotai/revm/pull/321))
- *(deps)* bump tokio from 1.22.0 to 1.23.0 ([#284](https://github.com/imotai/revm/pull/284))
- remove --all-features from tests bcs of gas calc gets disabled ([#291](https://github.com/imotai/revm/pull/291))
...
- Bump revm to v2.3.0
- disable gas refunds with env flag ([#267](https://github.com/imotai/revm/pull/267))
- Export StorageSlot ([#265](https://github.com/imotai/revm/pull/265))
- Remove unused parking_lot dependency ([#244](https://github.com/imotai/revm/pull/244))
- v17 release notes, revm v2.2.0 ([#262](https://github.com/imotai/revm/pull/262))
- *(eth/test)* Added OEF spec for tests. Skip HighGasPrice ([#261](https://github.com/imotai/revm/pull/261))
- if returndatacopy is len 0 return after initial cost ([#259](https://github.com/imotai/revm/pull/259))
- typos ([#232](https://github.com/imotai/revm/pull/232))
- Borrow self and add derive traits for OpCode ([#231](https://github.com/imotai/revm/pull/231))
- Bump revm v2.1.0 ([#224](https://github.com/imotai/revm/pull/224))
- expose original value on storageslot ([#216](https://github.com/imotai/revm/pull/216))
- revm bump v2.0.0, precompile bump v1.1.1 ([#212](https://github.com/imotai/revm/pull/212))
- Optimize gas calculation U256 to u64 ([#213](https://github.com/imotai/revm/pull/213))
...
- export create address calls ([#209](https://github.com/imotai/revm/pull/209))
- Cargo sort. Bump lib versions ([#208](https://github.com/imotai/revm/pull/208))
- *(deps)* bump futures from 0.3.23 to 0.3.24 ([#194](https://github.com/imotai/revm/pull/194))
- use Infallible for memory db's error type ([#196](https://github.com/imotai/revm/pull/196))
- reexport revm_precompiles as precompiles ([#197](https://github.com/imotai/revm/pull/197))
- Cache precompile hashmaps ([#192](https://github.com/imotai/revm/pull/192))
- Add support for old forks. ([#191](https://github.com/imotai/revm/pull/191))
- export JournaledState ([#190](https://github.com/imotai/revm/pull/190))
- Revert "refactor(revm): use u64 for gas refund counter ([#180](https://github.com/imotai/revm/pull/180))" ([#187](https://github.com/imotai/revm/pull/187))
- *(revm)* use u64 for gas refund counter ([#180](https://github.com/imotai/revm/pull/180))
- *(precompiles)* Vec -> BTreeMap ([#177](https://github.com/imotai/revm/pull/177))
- *(deps)* bump futures from 0.3.21 to 0.3.23 ([#173](https://github.com/imotai/revm/pull/173))
- Handle HighNonce tests ([#176](https://github.com/imotai/revm/pull/176))
- JournaledState ([#175](https://github.com/imotai/revm/pull/175))
- Update account storage methods in CacheDB ([#171](https://github.com/imotai/revm/pull/171))
- Return `ExecutionResult`, which includes `gas_refunded` ([#169](https://github.com/imotai/revm/pull/169))
- Optimize calldataload. Some cleanup ([#168](https://github.com/imotai/revm/pull/168))
- bump revm v1.9.0
- Bytecode hash, remove override_spec, ([#165](https://github.com/imotai/revm/pull/165))
- revm bump 1.8. update libs. snailtracer rename ([#159](https://github.com/imotai/revm/pull/159))
- bump revm_precompiles to v1.1.0
- bump revm to v1.7.0
- Byzantine to Byzantium ([#146](https://github.com/imotai/revm/pull/146))
...
- Return specific `Return` statuses in `CALL`s ([#136](https://github.com/imotai/revm/pull/136))
...
- enable EIP2200 in Istanbul ([#125](https://github.com/imotai/revm/pull/125))
- Consensus error with gas block for SSTORE stipend check ([#124](https://github.com/imotai/revm/pull/124))
- v9 release notes
- export evm_inner ([#122](https://github.com/imotai/revm/pull/122))
- *(deps)* bump auto_impl from 0.5.0 to 1.0.1 ([#118](https://github.com/imotai/revm/pull/118))
- [revm] bump to v1.4.0
- *(clippy)* make clippy happy ([#120](https://github.com/imotai/revm/pull/120))
- rm empty line
- changelog for v7 tag
- empty keccak constant and remove access_list.clone ([#111](https://github.com/imotai/revm/pull/111))
- typo fixes
...
- Update AccountInfo#code documentation ([#94](https://github.com/imotai/revm/pull/94))
- Various fixes ([#93](https://github.com/imotai/revm/pull/93))
- remove untable fmt
- nit
- [revm] optimize is_push check
- turn off default features for zkp-u256 ([#68](https://github.com/imotai/revm/pull/68))
- Bump futures from 0.3.17 to 0.3.21 ([#64](https://github.com/imotai/revm/pull/64))
- bump dependencies ([#63](https://github.com/imotai/revm/pull/63))
...
- [revm][perf] Error refactor to Return ([#9](https://github.com/imotai/revm/pull/9))
