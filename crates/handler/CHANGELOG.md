...
## [16.0.0](https://github.com/imotai/revm/compare/revm-handler-v15.0.0...revm-handler-v16.0.0) - 2026-02-27
...
- *(handler)* respect is_fee_charge_disabled in calculate_caller_fee ([#3401](https://github.com/imotai/revm/pull/3401))

### Other

- *(handler)* remove Default for EthPrecompiles and EthInstructions ([#3434](https://github.com/imotai/revm/pull/3434))
- remove unused alloy-provider dev-dependency ([#3423](https://github.com/imotai/revm/pull/3423))
...
- *(revm-handler)* add ItemOrResult::map_item (alias map_frame) ([#3320](https://github.com/imotai/revm/pull/3320))
