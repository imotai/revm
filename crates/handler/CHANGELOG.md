...
## [11.3.0](https://github.com/imotai/revm/compare/revm-handler-v11.2.0...revm-handler-v11.3.0) - 2025-10-23

### Added

- JournaledAccount, a nice way to update and track changes ([#3086](https://github.com/imotai/revm/pull/3086))
- dont load access list immediately ([#3116](https://github.com/imotai/revm/pull/3116))
