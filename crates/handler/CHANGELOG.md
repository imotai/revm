...
## [9.0.0](https://github.com/imotai/revm/compare/revm-handler-v8.1.0...revm-handler-v9.0.0) - 2025-08-01
...
- improve ExtBytecode hash handling ([#2826](https://github.com/imotai/revm/pull/2826))
- fix run-tests.sh ([#2801](https://github.com/imotai/revm/pull/2801))
