...
## [12.0.1](https://github.com/imotai/revm/compare/revm-handler-v12.0.0...revm-handler-v12.0.1) - 2025-10-31

### Other

- updated the following local packages: revm-primitives, revm-bytecode, revm-state, revm-database-interface, revm-context-interface, revm-context, revm-database, revm-interpreter, revm-precompile
