...
## [7.0.6](https://github.com/imotai/revm/compare/revm-state-v7.0.5...revm-state-v7.0.6) - 2025-10-02
...
- *(state)* remove unnecessary core::hash::Hash import from lib.rs ([#2959](https://github.com/imotai/revm/pull/2959))
- add SECURITY.md ([#2956](https://github.com/imotai/revm/pull/2956))
- use primitives::HashMap default ([#2916](https://github.com/imotai/revm/pull/2916))
