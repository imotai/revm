...
## [10.0.0](https://github.com/imotai/revm/compare/revm-state-v9.0.0...revm-state-v10.0.0) - 2026-02-27

### Fixed

- set transition_id to account ([#3353](https://github.com/imotai/revm/pull/3353))

### Other

- [**breaking**] flatten Bytecode ([#3375](https://github.com/imotai/revm/pull/3375))
- *(state)* avoid unnecessary clone, prealloc, and fix typo ([#3387](https://github.com/imotai/revm/pull/3387))
