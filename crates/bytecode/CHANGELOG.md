...
## [7.2.0](https://github.com/imotai/revm/compare/revm-bytecode-v7.1.1...revm-bytecode-v7.2.0) - 2026-01-09
...
- *(bytecode)* remove duplicate implementation in bytes_ref method ([#3276](https://github.com/imotai/revm/pull/3276))
- the MLOAD opcode can resize memory ([#3266](https://github.com/imotai/revm/pull/3266))
...
- the KECCAK256 opcode can resize memory ([#3269](https://github.com/imotai/revm/pull/3269))
