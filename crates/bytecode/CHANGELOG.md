...
## [9.0.0](https://github.com/imotai/revm/compare/revm-bytecode-v8.0.0...revm-bytecode-v9.0.0) - 2026-02-27

### Added

- Implement EIP-7843 SLOTNUM opcode for Amsterdam ([#3340](https://github.com/imotai/revm/pull/3340))
- Implement EIP-8024 for Amsterdam ([#3223](https://github.com/imotai/revm/pull/3223))

### Fixed

- add a test utility function to generate memory input opcodes ([#3280](https://github.com/imotai/revm/pull/3280))
- *(bytecode)* add padding for final opcode missing immediates ([#3338](https://github.com/imotai/revm/pull/3338))
- *(bytecode)* improve analyze_legacy and stack tests ([#3335](https://github.com/imotai/revm/pull/3335))
- the LOG[0-4] CREATE CREATE2 opcode can modify memory ([#3328](https://github.com/imotai/revm/pull/3328))
- *(bytecode)* improve analyze_legacy padding for SWAPN/DUPN/EXCHANGE ([#3332](https://github.com/imotai/revm/pull/3332))
...
- *(tests)* remove redundant clones in legacy analysis tests ([#3317](https://github.com/imotai/revm/pull/3317))
