...
## [6.3.0](https://github.com/imotai/revm/compare/revm-bytecode-v6.2.2...revm-bytecode-v6.3.0) - 2025-10-02

### Added

- in JumpTable use Bytes instead of BitVec ([#3014](https://github.com/imotai/revm/pull/3014))

### Fixed

- *(bytecode)* exclude MLOAD from modifies_memory and update test ([#3004](https://github.com/imotai/revm/pull/3004))
- Apply spelling corrections from PRs #2926, #2915, #2908 ([#2978](https://github.com/imotai/revm/pull/2978))

### Other

- use offset_from_unsigned ([#2999](https://github.com/imotai/revm/pull/2999))
