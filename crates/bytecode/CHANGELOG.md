...
## [6.2.1](https://github.com/imotai/revm/compare/revm-bytecode-v6.2.0...revm-bytecode-v6.2.1) - 2025-08-09

### Other

- update outdated opcode memory reference link ([#2859](https://github.com/imotai/revm/pull/2859))
