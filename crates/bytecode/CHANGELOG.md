...
## [6.2.0](https://github.com/imotai/revm/compare/revm-bytecode-v6.1.0...revm-bytecode-v6.2.0) - 2025-08-01

### Added

- removed padding in case last opcode is terminating or unknown ([#2816](https://github.com/imotai/revm/pull/2816))
