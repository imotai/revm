...
## [7.2.2](https://github.com/imotai/revm/compare/revme-v7.2.1...revme-v7.2.2) - 2025-08-13

### Other

- updated the following local packages: revm-bytecode, revm-database-interface, revm-database, revm-state, revm-context-interface, revm-context, revm-inspector, revm, revm-statetest-types
